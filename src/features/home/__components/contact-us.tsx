          ...
          <div className='flex flex-row gap-x-4 lg:justify-between'>
            <div className='w-full px-4 lg:w-1/2 xl:w-6/12'>
              <div className='mb-12 max-w-[570px] lg:mb-0'>
                ...
                We’re here to help!
                If you have any questions, need more information, or would like to collaborate, feel free to reach out to us using the contact details below. 
                Our team will be happy to respond as soon as possible.
                ...
                <div className='mb-8 flex w-full max-w-[370px]'>
                  ...
                  <div className='w-full'>
                    ...
                    Ruko Ketintang Jetis Sraten Park, Jl. Ketintang Baru Sel. I No. 33, Kota Surabaya, Provinsi Jawa Timur
                    </p>
                  </div>
                </div>
